    ...
    public void onMessage(Message message) {
        try {
            ...
            if (replyTo != null) {
                ...
                System.out.println(message.getStringProperty("jobName") + " " + message.getIntProperty("id"));
                Message response = session.createTextMessage("Job " + message.getIntProperty("id") + " Finished");
